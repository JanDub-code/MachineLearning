...
2.  **FÁZE B: RF Classifier (Predikční mozek)**
    ...
    *   **Vztah:** Dynamický, časový vztah. "Co se stane zítra na základě toho, co vím dnes?"
    *   **Výsledek:** **Accuracy 35,6%** (o 2,3% nad náhodu).
    *   **Klíčový driver:** **Returns (výnosy)** a **RSI** (momentum). Fundamenty zde slouží jako "kotva".
...
*   **ROC Curve / AUC (0.55):** Křivka nad diagonálou je vizuální důkaz, že model prokazatelně rozlišuje signál od šumu.

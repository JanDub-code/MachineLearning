...
"""
Příprava 10letých OHLCV dat s technickými indikátory.
Stahuje DENNÍ data, agreguje na MĚSÍČNÍ, počítá volatilitu, returns, RSI, MACD.
"""
...
def main():
    log("=" * 80)
    log("PŘÍPRAVA 10LETÝCH OHLCV DAT S TECHNICKÝMI INDIKÁTORY")
    log("=" * 80)
